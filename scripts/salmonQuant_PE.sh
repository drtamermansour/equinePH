...
## Salmon v0.8.2 has been installed in the home directory
...
cd $PBS_O_WORKDIR
label=$(basename $identifier)
salmon quant -i "$index" --libType A -1 <(cat ${identifier}_*_R1_001.pe.fq) -2 <(cat ${identifier}_*_R2_001.pe.fq) -o $label.PE.quant;
